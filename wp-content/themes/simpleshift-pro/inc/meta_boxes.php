...
$meta_box_options['simpleshift_sidebar_meta_box']['priority'] = 'high';
$meta_box_options['simpleshift_sidebar_meta_box']['fields']['sidebar_select']
    = array('type'=>'radio',
            'options'=>array('left'=>__('Left','simpleshift-pro'), 'right'=>__('Right','simpleshift-pro'), 'none'=>__('None','simpleshift-pro')),
            'default'=>'none',
            'script'=>'',
            'help'=>__('Sidebar Display Options:','simpleshift-pro')
            );
$meta_box_options['simpleshift_sidebar_meta_box']['fields']['sidebar_number']
    = array('type'=>'textbox',
            'default'=>'',
            'script'=>'',
            'label'=>__('Sidebar #:','simpleshift-pro'),
            'help'=>__('Enter the number of the alternate sidebar you would like to apply. Leave blank to use default.','simpleshift-pro'),
            'size'=>2
            );
...
$meta_box_options['simpleshift_featured_img_meta_box']['id'] = 'featured_img_meta_box';
$meta_box_options['simpleshift_featured_img_meta_box']['title'] = 'SimpleShift Featured Images';
$meta_box_options['simpleshift_featured_img_meta_box']['callback'] = 'simpleshift_call_featured_img_meta_box'; #create
$meta_box_options['simpleshift_featured_img_meta_box']['post_type'] = 'page,post';
$meta_box_options['simpleshift_featured_img_meta_box']['context'] = 'side';
$meta_box_options['simpleshift_featured_img_meta_box']['priority'] = 'high';


$meta_box_options['simpleshift_featured_img_meta_box']['fields']['toggle_featured']
    = array('type'=>'radio',
            'options'=>array('show'=>__('Show','simpleshift-pro'), 'hide'=>__('Hide','simpleshift-pro')),
            'default'=>'show',
            'script'=>'',
            'help'=>__('Show/Hide Featured Image Banner','simpleshift-pro')
            );


add_action("admin_init", "simpleshift_featured_img_meta_box");
add_action('save_post', 'simpleshift_save_featured_img_meta_box');



function simpleshift_featured_img_meta_box() {
    $key = 'simpleshift_featured_img_meta_box';
    global $meta_box_options;
    $id = $meta_box_options[$key]['id'];
    $title = $meta_box_options[$key]['title'];
    $callback = $meta_box_options[$key]['callback'];
...
function simpleshift_call_featured_img_meta_box() {

    wp_register_script('jscolor', get_template_directory_uri() . '/simpleshift/assets/js/jscolor/jscolor.js', array('jquery'), '1.0');
    ...
    $fields = $meta_box_options[$key]['fields'];
    simpleshift_output_metabox_style($meta_box_options['simpleshift_featured_img_meta_box']['id'], $meta_box_options['simpleshift_featured_img_meta_box']['context']);
    simpleshift_metabox_nonce();
    simpleshift_draw_fields($fields, $post->ID);
}

function simpleshift_save_featured_img_meta_box($post_id) {
